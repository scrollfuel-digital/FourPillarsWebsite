...
export default function AboutView() {
  ...
  return (
    ...
    >
      <Helmet>
        <title>About Us | 4 Pillars Realty Nagpur - Legal Clarity & Transparency</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="About Us | 4 Pillars Realty Nagpur - Legal Clarity & Transparency" />
        <meta
