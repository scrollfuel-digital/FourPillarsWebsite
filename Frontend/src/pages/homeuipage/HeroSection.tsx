...
const BACKGROUND_VIDEO =
  "https://res.cloudinary.com/ds1y9wivv/video/upload/v1787828694/PillarWebsiteVideo_focjfe.mp4";
  ...
  return (
    ...
    >
      ...
      <motion.div className="absolute inset-0 z-0" style={{ y: heroY }}>
        ...
        {/* Loading background */}
        <div
          className={`absolute inset-0 bg-[#101820] transition-opacity duration-700 ${
